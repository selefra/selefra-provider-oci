...
type TableOciNosqlTableMetricStorageUtilizationDailyGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableOciNosqlTableMetricStorageUtilizationDailyGenerator{}

func (x *TableOciNosqlTableMetricStorageUtilizationDailyGenerator) GetTableName() string {
	return "oci_nosql_table_metric_storage_utilization_daily"
}

func (x *TableOciNosqlTableMetricStorageUtilizationDailyGenerator) GetTableDescription() string {
	return ""
}

func (x *TableOciNosqlTableMetricStorageUtilizationDailyGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableOciNosqlTableMetricStorageUtilizationDailyGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableOciNosqlTableMetricStorageUtilizationDailyGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, taskClient any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {
			...
			_, err := listMonitoringMetricStatistics(ctx, clientMeta, taskClient, task, resultChannel, "DAILY", "oci_nosql", "StorageGB", "tableName", *table.Name, *table.CompartmentId, region)
			if err != nil {
...
func (x *TableOciNosqlTableMetricStorageUtilizationDailyGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return oci_client.BuildRegionList()
}

func (x *TableOciNosqlTableMetricStorageUtilizationDailyGenerator) GetColumns() []*schema.Column {
...
func (x *TableOciNosqlTableMetricStorageUtilizationDailyGenerator) GetSubTables() []*schema.Table {
	return nil
}
