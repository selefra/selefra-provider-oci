...
type TableOciCoreBootVolumeMetricWriteOpsGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableOciCoreBootVolumeMetricWriteOpsGenerator{}

func (x *TableOciCoreBootVolumeMetricWriteOpsGenerator) GetTableName() string {
	return "oci_core_boot_volume_metric_write_ops"
}

func (x *TableOciCoreBootVolumeMetricWriteOpsGenerator) GetTableDescription() string {
	return ""
}

func (x *TableOciCoreBootVolumeMetricWriteOpsGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableOciCoreBootVolumeMetricWriteOpsGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableOciCoreBootVolumeMetricWriteOpsGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, taskClient any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {
			...
			_, err := listMonitoringMetricStatistics(ctx, clientMeta, taskClient, task, resultChannel, "5_MIN", "oci_blockstore", "VolumeWriteOps", "resourceId", *volume.Id, *volume.CompartmentId, region)
...
func (x *TableOciCoreBootVolumeMetricWriteOpsGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return oci_client.BuildCompartementZonalList()
}

func (x *TableOciCoreBootVolumeMetricWriteOpsGenerator) GetColumns() []*schema.Column {
...
func (x *TableOciCoreBootVolumeMetricWriteOpsGenerator) GetSubTables() []*schema.Table {
	return nil
}
