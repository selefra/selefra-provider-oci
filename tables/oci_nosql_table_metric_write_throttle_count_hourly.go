...
type TableOciNosqlTableMetricWriteThrottleCountHourlyGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableOciNosqlTableMetricWriteThrottleCountHourlyGenerator{}

func (x *TableOciNosqlTableMetricWriteThrottleCountHourlyGenerator) GetTableName() string {
	return "oci_nosql_table_metric_write_throttle_count_hourly"
}

func (x *TableOciNosqlTableMetricWriteThrottleCountHourlyGenerator) GetTableDescription() string {
	return ""
}

func (x *TableOciNosqlTableMetricWriteThrottleCountHourlyGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableOciNosqlTableMetricWriteThrottleCountHourlyGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableOciNosqlTableMetricWriteThrottleCountHourlyGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, taskClient any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {
			...
			_, err := listMonitoringMetricStatistics(ctx, clientMeta, taskClient, task, resultChannel, "HOURLY", "oci_nosql", "WriteThrottleCount", "tableName", *table.Name, *table.CompartmentId, region)
			if err != nil {
...
func (x *TableOciNosqlTableMetricWriteThrottleCountHourlyGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return oci_client.BuildRegionList()
}

func (x *TableOciNosqlTableMetricWriteThrottleCountHourlyGenerator) GetColumns() []*schema.Column {
...
func (x *TableOciNosqlTableMetricWriteThrottleCountHourlyGenerator) GetSubTables() []*schema.Table {
	return nil
}
