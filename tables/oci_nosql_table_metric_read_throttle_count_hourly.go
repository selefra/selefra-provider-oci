...
type TableOciNosqlTableMetricReadThrottleCountHourlyGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableOciNosqlTableMetricReadThrottleCountHourlyGenerator{}

func (x *TableOciNosqlTableMetricReadThrottleCountHourlyGenerator) GetTableName() string {
	return "oci_nosql_table_metric_read_throttle_count_hourly"
}

func (x *TableOciNosqlTableMetricReadThrottleCountHourlyGenerator) GetTableDescription() string {
	return ""
}

func (x *TableOciNosqlTableMetricReadThrottleCountHourlyGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableOciNosqlTableMetricReadThrottleCountHourlyGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableOciNosqlTableMetricReadThrottleCountHourlyGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, taskClient any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {
			...
			_, err := listMonitoringMetricStatistics(ctx, clientMeta, taskClient, task, resultChannel, "HOURLY", "oci_nosql", "ReadThrottleCount", "tableName", *table.Name, *table.CompartmentId, region)
			if err != nil {
...
func (x *TableOciNosqlTableMetricReadThrottleCountHourlyGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return oci_client.BuildRegionList()
}

func (x *TableOciNosqlTableMetricReadThrottleCountHourlyGenerator) GetColumns() []*schema.Column {
...
func (x *TableOciNosqlTableMetricReadThrottleCountHourlyGenerator) GetSubTables() []*schema.Table {
	return nil
}
