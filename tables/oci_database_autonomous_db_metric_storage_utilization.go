...
type TableOciDatabaseAutonomousDbMetricStorageUtilizationGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableOciDatabaseAutonomousDbMetricStorageUtilizationGenerator{}

func (x *TableOciDatabaseAutonomousDbMetricStorageUtilizationGenerator) GetTableName() string {
	return "oci_database_autonomous_db_metric_storage_utilization"
}

func (x *TableOciDatabaseAutonomousDbMetricStorageUtilizationGenerator) GetTableDescription() string {
	return ""
}

func (x *TableOciDatabaseAutonomousDbMetricStorageUtilizationGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableOciDatabaseAutonomousDbMetricStorageUtilizationGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableOciDatabaseAutonomousDbMetricStorageUtilizationGenerator) GetDataSource() *schema.DataSource {
...
func (x *TableOciDatabaseAutonomousDbMetricStorageUtilizationGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return oci_client.BuildRegionList()
}

func (x *TableOciDatabaseAutonomousDbMetricStorageUtilizationGenerator) GetColumns() []*schema.Column {
...
func (x *TableOciDatabaseAutonomousDbMetricStorageUtilizationGenerator) GetSubTables() []*schema.Table {
	return nil
}
