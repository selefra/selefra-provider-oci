...
type TableOciCoreBootVolumeMetricWriteOpsDailyGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableOciCoreBootVolumeMetricWriteOpsDailyGenerator{}

func (x *TableOciCoreBootVolumeMetricWriteOpsDailyGenerator) GetTableName() string {
	return "oci_core_boot_volume_metric_write_ops_daily"
}

func (x *TableOciCoreBootVolumeMetricWriteOpsDailyGenerator) GetTableDescription() string {
	return ""
}

func (x *TableOciCoreBootVolumeMetricWriteOpsDailyGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableOciCoreBootVolumeMetricWriteOpsDailyGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableOciCoreBootVolumeMetricWriteOpsDailyGenerator) GetDataSource() *schema.DataSource {
...
func (x *TableOciCoreBootVolumeMetricWriteOpsDailyGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return oci_client.BuildCompartementZonalList()
}

func (x *TableOciCoreBootVolumeMetricWriteOpsDailyGenerator) GetColumns() []*schema.Column {
...
func (x *TableOciCoreBootVolumeMetricWriteOpsDailyGenerator) GetSubTables() []*schema.Table {
	return nil
}
