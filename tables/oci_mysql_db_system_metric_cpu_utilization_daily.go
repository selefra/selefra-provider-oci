...
type TableOciMysqlDbSystemMetricCpuUtilizationDailyGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableOciMysqlDbSystemMetricCpuUtilizationDailyGenerator{}

func (x *TableOciMysqlDbSystemMetricCpuUtilizationDailyGenerator) GetTableName() string {
	return "oci_mysql_db_system_metric_cpu_utilization_daily"
}

func (x *TableOciMysqlDbSystemMetricCpuUtilizationDailyGenerator) GetTableDescription() string {
	return ""
}

func (x *TableOciMysqlDbSystemMetricCpuUtilizationDailyGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableOciMysqlDbSystemMetricCpuUtilizationDailyGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableOciMysqlDbSystemMetricCpuUtilizationDailyGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, taskClient any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {
			...
			_, err := listMonitoringMetricStatistics(ctx, clientMeta, taskClient, task, resultChannel, "DAILY", "oci_mysql_database", "CPUUtilization", "resourceId", *dbSystem.Id, *dbSystem.CompartmentId, region)
			if err != nil {
...
func (x *TableOciMysqlDbSystemMetricCpuUtilizationDailyGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return oci_client.BuildRegionList()
}

func (x *TableOciMysqlDbSystemMetricCpuUtilizationDailyGenerator) GetColumns() []*schema.Column {
...
func (x *TableOciMysqlDbSystemMetricCpuUtilizationDailyGenerator) GetSubTables() []*schema.Table {
	return nil
}
