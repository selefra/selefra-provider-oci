...
type TableOciCoreInstanceMetricCpuUtilizationHourlyGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableOciCoreInstanceMetricCpuUtilizationHourlyGenerator{}

func (x *TableOciCoreInstanceMetricCpuUtilizationHourlyGenerator) GetTableName() string {
	return "oci_core_instance_metric_cpu_utilization_hourly"
}

func (x *TableOciCoreInstanceMetricCpuUtilizationHourlyGenerator) GetTableDescription() string {
	return ""
}

func (x *TableOciCoreInstanceMetricCpuUtilizationHourlyGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableOciCoreInstanceMetricCpuUtilizationHourlyGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableOciCoreInstanceMetricCpuUtilizationHourlyGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, taskClient any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {
			...
			_, err := listMonitoringMetricStatistics(ctx, clientMeta, taskClient, task, resultChannel, "HOURLY", "oci_computeagent", "CpuUtilization", "resourceId", *instance.Id, *instance.CompartmentId, region)
...
func (x *TableOciCoreInstanceMetricCpuUtilizationHourlyGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return oci_client.BuildRegionList()
}

func (x *TableOciCoreInstanceMetricCpuUtilizationHourlyGenerator) GetColumns() []*schema.Column {
...
func (x *TableOciCoreInstanceMetricCpuUtilizationHourlyGenerator) GetSubTables() []*schema.Table {
	return nil
}
