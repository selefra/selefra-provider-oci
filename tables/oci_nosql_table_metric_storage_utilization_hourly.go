...
type TableOciNosqlTableMetricStorageUtilizationHourlyGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableOciNosqlTableMetricStorageUtilizationHourlyGenerator{}

func (x *TableOciNosqlTableMetricStorageUtilizationHourlyGenerator) GetTableName() string {
	return "oci_nosql_table_metric_storage_utilization_hourly"
}

func (x *TableOciNosqlTableMetricStorageUtilizationHourlyGenerator) GetTableDescription() string {
	return ""
}

func (x *TableOciNosqlTableMetricStorageUtilizationHourlyGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableOciNosqlTableMetricStorageUtilizationHourlyGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableOciNosqlTableMetricStorageUtilizationHourlyGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, taskClient any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {
			...
			_, err := listMonitoringMetricStatistics(ctx, clientMeta, taskClient, task, resultChannel, "HOURLY", "oci_nosql", "StorageGB", "tableName", *table.Name, *table.CompartmentId, region)
			if err != nil {
...
func (x *TableOciNosqlTableMetricStorageUtilizationHourlyGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return oci_client.BuildRegionList()
}

func (x *TableOciNosqlTableMetricStorageUtilizationHourlyGenerator) GetColumns() []*schema.Column {
...
func (x *TableOciNosqlTableMetricStorageUtilizationHourlyGenerator) GetSubTables() []*schema.Table {
	return nil
}
