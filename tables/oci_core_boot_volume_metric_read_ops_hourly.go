...
type TableOciCoreBootVolumeMetricReadOpsHourlyGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableOciCoreBootVolumeMetricReadOpsHourlyGenerator{}

func (x *TableOciCoreBootVolumeMetricReadOpsHourlyGenerator) GetTableName() string {
	return "oci_core_boot_volume_metric_read_ops_hourly"
}

func (x *TableOciCoreBootVolumeMetricReadOpsHourlyGenerator) GetTableDescription() string {
	return ""
}

func (x *TableOciCoreBootVolumeMetricReadOpsHourlyGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableOciCoreBootVolumeMetricReadOpsHourlyGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableOciCoreBootVolumeMetricReadOpsHourlyGenerator) GetDataSource() *schema.DataSource {
...
func (x *TableOciCoreBootVolumeMetricReadOpsHourlyGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return oci_client.BuildCompartementZonalList()
}

func (x *TableOciCoreBootVolumeMetricReadOpsHourlyGenerator) GetColumns() []*schema.Column {
...
func (x *TableOciCoreBootVolumeMetricReadOpsHourlyGenerator) GetSubTables() []*schema.Table {
	return nil
}
