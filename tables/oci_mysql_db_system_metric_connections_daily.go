...
type TableOciMysqlDbSystemMetricConnectionsDailyGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableOciMysqlDbSystemMetricConnectionsDailyGenerator{}

func (x *TableOciMysqlDbSystemMetricConnectionsDailyGenerator) GetTableName() string {
	return "oci_mysql_db_system_metric_connections_daily"
}

func (x *TableOciMysqlDbSystemMetricConnectionsDailyGenerator) GetTableDescription() string {
	return ""
}

func (x *TableOciMysqlDbSystemMetricConnectionsDailyGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableOciMysqlDbSystemMetricConnectionsDailyGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableOciMysqlDbSystemMetricConnectionsDailyGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, taskClient any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {
			...
			_, err := listMonitoringMetricStatistics(ctx, clientMeta, taskClient, task, resultChannel, "Daily", "oci_mysql_database", "ActiveConnections", "resourceId", *dbSystem.Id, *dbSystem.CompartmentId, region)

			if err != nil {
				return schema.NewDiagnosticsErrorPullTable(task.Table, err)
			}

			_, err = listMonitoringMetricStatistics(ctx, clientMeta, taskClient, task, resultChannel, "Daily", "oci_mysql_database", "CurrentConnections", "resourceId", *dbSystem.Id, *dbSystem.CompartmentId, region)
...
func (x *TableOciMysqlDbSystemMetricConnectionsDailyGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return oci_client.BuildRegionList()
}

func (x *TableOciMysqlDbSystemMetricConnectionsDailyGenerator) GetColumns() []*schema.Column {
...
func (x *TableOciMysqlDbSystemMetricConnectionsDailyGenerator) GetSubTables() []*schema.Table {
	return nil
}
