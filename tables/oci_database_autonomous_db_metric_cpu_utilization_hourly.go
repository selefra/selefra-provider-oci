...
type TableOciDatabaseAutonomousDbMetricCpuUtilizationHourlyGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableOciDatabaseAutonomousDbMetricCpuUtilizationHourlyGenerator{}

func (x *TableOciDatabaseAutonomousDbMetricCpuUtilizationHourlyGenerator) GetTableName() string {
	return "oci_database_autonomous_db_metric_cpu_utilization_hourly"
}

func (x *TableOciDatabaseAutonomousDbMetricCpuUtilizationHourlyGenerator) GetTableDescription() string {
	return ""
}

func (x *TableOciDatabaseAutonomousDbMetricCpuUtilizationHourlyGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableOciDatabaseAutonomousDbMetricCpuUtilizationHourlyGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableOciDatabaseAutonomousDbMetricCpuUtilizationHourlyGenerator) GetDataSource() *schema.DataSource {
...
func (x *TableOciDatabaseAutonomousDbMetricCpuUtilizationHourlyGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return oci_client.BuildRegionList()
}

func (x *TableOciDatabaseAutonomousDbMetricCpuUtilizationHourlyGenerator) GetColumns() []*schema.Column {
...
func (x *TableOciDatabaseAutonomousDbMetricCpuUtilizationHourlyGenerator) GetSubTables() []*schema.Table {
	return nil
}
