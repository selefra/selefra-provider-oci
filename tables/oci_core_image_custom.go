...
type TableOciCoreImageCustomGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableOciCoreImageCustomGenerator{}

func (x *TableOciCoreImageCustomGenerator) GetTableName() string {
	return "oci_core_image_custom"
}

func (x *TableOciCoreImageCustomGenerator) GetTableDescription() string {
	return ""
}

func (x *TableOciCoreImageCustomGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableOciCoreImageCustomGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableOciCoreImageCustomGenerator) GetDataSource() *schema.DataSource {
...
func buildImageFilter() core.ListImagesRequest {
	request := core.ListImagesRequest{}

	return request
}

func (x *TableOciCoreImageCustomGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return oci_client.BuildRegionList()
}

func (x *TableOciCoreImageCustomGenerator) GetColumns() []*schema.Column {
...
func (x *TableOciCoreImageCustomGenerator) GetSubTables() []*schema.Table {
	return nil
}
