...
type TableOciDatabaseAutonomousDbMetricStorageUtilizationHourlyGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableOciDatabaseAutonomousDbMetricStorageUtilizationHourlyGenerator{}

func (x *TableOciDatabaseAutonomousDbMetricStorageUtilizationHourlyGenerator) GetTableName() string {
	return "oci_database_autonomous_db_metric_storage_utilization_hourly"
}

func (x *TableOciDatabaseAutonomousDbMetricStorageUtilizationHourlyGenerator) GetTableDescription() string {
	return ""
}

func (x *TableOciDatabaseAutonomousDbMetricStorageUtilizationHourlyGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableOciDatabaseAutonomousDbMetricStorageUtilizationHourlyGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableOciDatabaseAutonomousDbMetricStorageUtilizationHourlyGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, taskClient any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {
			...
			_, err := listMonitoringMetricStatistics(ctx, clientMeta, taskClient, task, resultChannel, "HOURLY", "oci_autonomous_database", "CpuUtilization", "resourceId", *database.Id, *database.CompartmentId, region)
			if err != nil {
...
func (x *TableOciDatabaseAutonomousDbMetricStorageUtilizationHourlyGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return oci_client.BuildRegionList()
}

func (x *TableOciDatabaseAutonomousDbMetricStorageUtilizationHourlyGenerator) GetColumns() []*schema.Column {
...
func (x *TableOciDatabaseAutonomousDbMetricStorageUtilizationHourlyGenerator) GetSubTables() []*schema.Table {
	return nil
}
