...
type TableOciMysqlDbSystemMetricCpuUtilizationHourlyGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableOciMysqlDbSystemMetricCpuUtilizationHourlyGenerator{}

func (x *TableOciMysqlDbSystemMetricCpuUtilizationHourlyGenerator) GetTableName() string {
	return "oci_mysql_db_system_metric_cpu_utilization_hourly"
}

func (x *TableOciMysqlDbSystemMetricCpuUtilizationHourlyGenerator) GetTableDescription() string {
	return ""
}

func (x *TableOciMysqlDbSystemMetricCpuUtilizationHourlyGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableOciMysqlDbSystemMetricCpuUtilizationHourlyGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableOciMysqlDbSystemMetricCpuUtilizationHourlyGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, taskClient any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {
			...
			_, err := listMonitoringMetricStatistics(ctx, clientMeta, taskClient, task, resultChannel, "HOURLY", "oci_mysql_database", "CPUUtilization", "resourceId", *dbSystem.Id, *dbSystem.CompartmentId, region)
			if err != nil {
...
func (x *TableOciMysqlDbSystemMetricCpuUtilizationHourlyGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return oci_client.BuildRegionList()
}

func (x *TableOciMysqlDbSystemMetricCpuUtilizationHourlyGenerator) GetColumns() []*schema.Column {
...
func (x *TableOciMysqlDbSystemMetricCpuUtilizationHourlyGenerator) GetSubTables() []*schema.Table {
	return nil
}
