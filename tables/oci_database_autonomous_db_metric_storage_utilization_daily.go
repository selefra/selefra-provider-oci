...
type TableOciDatabaseAutonomousDbMetricStorageUtilizationDailyGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableOciDatabaseAutonomousDbMetricStorageUtilizationDailyGenerator{}

func (x *TableOciDatabaseAutonomousDbMetricStorageUtilizationDailyGenerator) GetTableName() string {
	return "oci_database_autonomous_db_metric_storage_utilization_daily"
}

func (x *TableOciDatabaseAutonomousDbMetricStorageUtilizationDailyGenerator) GetTableDescription() string {
	return ""
}

func (x *TableOciDatabaseAutonomousDbMetricStorageUtilizationDailyGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableOciDatabaseAutonomousDbMetricStorageUtilizationDailyGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableOciDatabaseAutonomousDbMetricStorageUtilizationDailyGenerator) GetDataSource() *schema.DataSource {
...
func (x *TableOciDatabaseAutonomousDbMetricStorageUtilizationDailyGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return oci_client.BuildRegionList()
}

func (x *TableOciDatabaseAutonomousDbMetricStorageUtilizationDailyGenerator) GetColumns() []*schema.Column {
...
func (x *TableOciDatabaseAutonomousDbMetricStorageUtilizationDailyGenerator) GetSubTables() []*schema.Table {
	return nil
}
