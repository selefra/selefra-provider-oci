...
type TableOciMysqlDbSystemMetricMemoryUtilizationDailyGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableOciMysqlDbSystemMetricMemoryUtilizationDailyGenerator{}

func (x *TableOciMysqlDbSystemMetricMemoryUtilizationDailyGenerator) GetTableName() string {
	return "oci_mysql_db_system_metric_memory_utilization_daily"
}

func (x *TableOciMysqlDbSystemMetricMemoryUtilizationDailyGenerator) GetTableDescription() string {
	return ""
}

func (x *TableOciMysqlDbSystemMetricMemoryUtilizationDailyGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableOciMysqlDbSystemMetricMemoryUtilizationDailyGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableOciMysqlDbSystemMetricMemoryUtilizationDailyGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, taskClient any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {
			...
			_, err := listMonitoringMetricStatistics(ctx, clientMeta, taskClient, task, resultChannel, "DAILY", "oci_mysql_database", "MemoryUtilization", "resourceId", *dbSystem.Id, *dbSystem.CompartmentId, region)
			if err != nil {
...
func (x *TableOciMysqlDbSystemMetricMemoryUtilizationDailyGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return oci_client.BuildRegionList()
}

func (x *TableOciMysqlDbSystemMetricMemoryUtilizationDailyGenerator) GetColumns() []*schema.Column {
...
func (x *TableOciMysqlDbSystemMetricMemoryUtilizationDailyGenerator) GetSubTables() []*schema.Table {
	return nil
}
