...
type TableOciCoreBootVolumeMetricReadOpsGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableOciCoreBootVolumeMetricReadOpsGenerator{}

func (x *TableOciCoreBootVolumeMetricReadOpsGenerator) GetTableName() string {
	return "oci_core_boot_volume_metric_read_ops"
}

func (x *TableOciCoreBootVolumeMetricReadOpsGenerator) GetTableDescription() string {
	return ""
}

func (x *TableOciCoreBootVolumeMetricReadOpsGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableOciCoreBootVolumeMetricReadOpsGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableOciCoreBootVolumeMetricReadOpsGenerator) GetDataSource() *schema.DataSource {
...
func (x *TableOciCoreBootVolumeMetricReadOpsGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return oci_client.BuildCompartementZonalList()
}

func (x *TableOciCoreBootVolumeMetricReadOpsGenerator) GetColumns() []*schema.Column {
...
func (x *TableOciCoreBootVolumeMetricReadOpsGenerator) GetSubTables() []*schema.Table {
	return nil
}
