...
type TableOciNosqlTableMetricReadThrottleCountGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableOciNosqlTableMetricReadThrottleCountGenerator{}

func (x *TableOciNosqlTableMetricReadThrottleCountGenerator) GetTableName() string {
	return "oci_nosql_table_metric_read_throttle_count"
}

func (x *TableOciNosqlTableMetricReadThrottleCountGenerator) GetTableDescription() string {
	return ""
}

func (x *TableOciNosqlTableMetricReadThrottleCountGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableOciNosqlTableMetricReadThrottleCountGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableOciNosqlTableMetricReadThrottleCountGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, taskClient any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {
			...
			_, err := listMonitoringMetricStatistics(ctx, clientMeta, taskClient, task, resultChannel, "5_MIN", "oci_nosql", "ReadThrottleCount", "tableName", *table.Name, *table.CompartmentId, region)
			if err != nil {
...
func (x *TableOciNosqlTableMetricReadThrottleCountGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return oci_client.BuildRegionList()
}

func (x *TableOciNosqlTableMetricReadThrottleCountGenerator) GetColumns() []*schema.Column {
...
func (x *TableOciNosqlTableMetricReadThrottleCountGenerator) GetSubTables() []*schema.Table {
	return nil
}
