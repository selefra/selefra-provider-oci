...
type TableOciNosqlTableMetricWriteThrottleCountGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableOciNosqlTableMetricWriteThrottleCountGenerator{}

func (x *TableOciNosqlTableMetricWriteThrottleCountGenerator) GetTableName() string {
	return "oci_nosql_table_metric_write_throttle_count"
}

func (x *TableOciNosqlTableMetricWriteThrottleCountGenerator) GetTableDescription() string {
	return ""
}

func (x *TableOciNosqlTableMetricWriteThrottleCountGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableOciNosqlTableMetricWriteThrottleCountGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableOciNosqlTableMetricWriteThrottleCountGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, taskClient any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {
			...
			_, err := listMonitoringMetricStatistics(ctx, clientMeta, taskClient, task, resultChannel, "5_MIN", "oci_nosql", "WriteThrottleCount", "tableName", *table.Name, *table.CompartmentId, region)
			if err != nil {
...
func (x *TableOciNosqlTableMetricWriteThrottleCountGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return oci_client.BuildRegionList()
}

func (x *TableOciNosqlTableMetricWriteThrottleCountGenerator) GetColumns() []*schema.Column {
...
func (x *TableOciNosqlTableMetricWriteThrottleCountGenerator) GetSubTables() []*schema.Table {
	return nil
}
