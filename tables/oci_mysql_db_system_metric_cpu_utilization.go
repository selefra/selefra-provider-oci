...
type TableOciMysqlDbSystemMetricCpuUtilizationGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableOciMysqlDbSystemMetricCpuUtilizationGenerator{}

func (x *TableOciMysqlDbSystemMetricCpuUtilizationGenerator) GetTableName() string {
	return "oci_mysql_db_system_metric_cpu_utilization"
}

func (x *TableOciMysqlDbSystemMetricCpuUtilizationGenerator) GetTableDescription() string {
	return ""
}

func (x *TableOciMysqlDbSystemMetricCpuUtilizationGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableOciMysqlDbSystemMetricCpuUtilizationGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableOciMysqlDbSystemMetricCpuUtilizationGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, taskClient any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {
			...
			_, err := listMonitoringMetricStatistics(ctx, clientMeta, taskClient, task, resultChannel, "5_MIN", "oci_mysql_database", "CPUUtilization", "resourceId", *dbSystem.Id, *dbSystem.CompartmentId, region)
			if err != nil {
...
func (x *TableOciMysqlDbSystemMetricCpuUtilizationGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return oci_client.BuildRegionList()
}

func (x *TableOciMysqlDbSystemMetricCpuUtilizationGenerator) GetColumns() []*schema.Column {
...
func (x *TableOciMysqlDbSystemMetricCpuUtilizationGenerator) GetSubTables() []*schema.Table {
	return nil
}
