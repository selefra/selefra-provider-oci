# Selefra Provider OCI

Use this repo as a raw reference to **tables and schema** for OCI resources. [Here's](https://github.com/selefra/selefra-provider-oci/blob/main/docs/tables/oci.md) a summary of full coverage. 
